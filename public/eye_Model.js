...
const diseaseDivs = {
  ...
  Cataract: document.getElementById('Cataract'),
  Diabetes: document.getElementById('Diabetes'),
  Glaucoma: document.getElementById('Glaucoma'),
  Hypertension: document.getElementById('Hypertension'),
  Normal: document.getElementById('Normal'),
  Other: document.getElementById('Other'),
  Myopia: document.getElementById('Myopia'),
};
...
async function sendImageForPrediction() {
  ...
  try {
    ...
    console.log('Fetch URL:', '/eye/upload');

    const response = await fetch('/eye/upload', {
      method: 'POST',
